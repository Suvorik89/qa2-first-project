...
public class Shop1aTest {
    ...
    private final By ITEM = By.xpath(".//a[@class = 'catalog-taxons-product__name']");
    //private final By ITEM_LINK = By.xpath("a[@class = 'catalog-taxons-product__image-anchor']");
    ...
    public void searchItemPrice() {
        ...
        action.moveToElement(browser.findElement(ITEM)).build().perform();
