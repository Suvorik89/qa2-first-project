...
public class homeWork2 {
    private final By INFO_ABOUT_ORDER = By.xpath(".//li[@class = 'site-top__menu-left-item'");
    private final By SWITCH_LANGUAGE_LV = By.xpath(".//a[@class = 'site-top__menu-right-link']");
    private final By SWITCH_LANGUAGE_RU = By.xpath(".//a[@class = 'site-top__menu-right-link']");
